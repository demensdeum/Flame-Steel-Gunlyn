...
export class AuthorizeController {
    constructor(delegate) {
        this.state = AuthorizeControllerState.Idle;
    ...
    async authorizeIfNeeded() {
        ...
        try {
            ...
            if (result.code == RequestResultCodes.Success) {
                ...
                this.delegate.authorizeControllerDidAuthorize(this, result.heroUUID);
            }
            else {
                this.state = AuthorizeControllerState.Error;
                this.delegate.authorizeControllerDidReceiveError(this, result.message);
            }
        }
        catch (error) {
            this.state = AuthorizeControllerState.Error;
